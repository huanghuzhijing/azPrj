...
import ARKit
import SceneKit
class EyeTrackViewController: UIViewController ,ARSCNViewDelegate{
    var moveFlag = 1
    ...
    @IBAction func touchTrack(_ sender: Any) {
        ...
        trackButton.setBackgroundImage(UIImage(), for: .normal)
        self.trackButton.setTitle("1", for: .normal)
        DispatchQueue.main.asyncAfter(deadline: DispatchTime.now() + 1){
           self.trackButton.setTitle("2", for: .normal)
        }
...
//            self.reset()
    ...
    func reset(){
        self.trackButton.setBackgroundImage(UIImage(named: "bullseye"), for: .normal)
    ...
    override func viewDidLoad() {
        ...
        trackButton.setBackgroundImage(UIImage(named: "bullseye"), for: .normal)
